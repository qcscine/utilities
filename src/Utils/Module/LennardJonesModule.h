...
#define SCINE_LENNARDJONES_MODULE_H
...
/**
 * @brief Lennard-Jones Module provided by OSUtils.
 */
class LennardJonesModule : public Core::Module {
 public:
...
#endif // SCINE_LENNARDJONES_MODULE_H
