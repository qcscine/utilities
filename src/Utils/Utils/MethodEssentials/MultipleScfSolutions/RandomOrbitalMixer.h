...
#include <Utils/MethodEssentials/util/LcaoUtil/MolecularOrbitalsManipulation.h>
#include <cassert>
#include <random>
...
class RandomOrbitalMixer {
 ...
 private:
  ...
  std::vector<LcaoUtil::MolecularOrbitalsManipulation::Mix> createMixes(const std::vector<int>& occ,
