...
TEST_F(ADftd3Calculation, HasCorrectDispersionEnergyandGradientForPBE) {
  std::stringstream ss("2\n\n"
                       "C     0.0000000000    0.0000000000   -0.0000000000\n"
...
TEST_F(ADftd3Calculation, HasCorrectDispersionEnergyForBP86) {
  std::stringstream ss("2\n\n"
                       "C     0.0000000000    0.0000000000   -0.0000000000\n"
                       "O     1.0000000000    0.0000000000    0.0000000000\n");
  auto atomCollection = XyzStreamHandler::read(ss);
...
TEST_F(ADftd3Calculation, HasCorrectDispersionEnergyandGradientForTPSS) {
...
TEST_F(ADftd3Calculation, HasCorrectDerivativeOfEnergyWrtDistance) {
  ...
  method.initialize(atomCollection1, 0.4535, 1.9435, 4.4752);
  ...
  method.initialize(atomCollection2, 0.4535, 1.9435, 4.4752);
  method.calculateValuesForConstants();
...
TEST_F(ADftd3Calculation, HasCorrectDispersionEnergyandGradientForPBE0) {
