...
class AHomoLumoGapCalculator : public Test {
 public:
  ...
  LcaoUtil::ElectronicOccupation occupation;
...
TEST_F(AHomoLumoGapCalculator, CalculatesHomoLumoGapForRestrictedWithEvenElectrons) {
  ...
  double homoLumoGap = LcaoUtil::HomoLumoGapCalculator::calculate(energies, occupation);
...
TEST_F(AHomoLumoGapCalculator, ThrowsWhenThereAreNoElectrons) {
  ...
  ASSERT_THROW(LcaoUtil::HomoLumoGapCalculator::calculate(energies, occupation), LcaoUtil::HomoLumoGapException);
